...
QUERY_RESULTS_BUCKET = 's3://query-results-location-taxi-availability-1/'
MY_DATABASE = 'taxi_availability_database'
SOURCE_PARQUET_TABLE_NAME = 'taxi_availability_data_parquet_tbl'
NEW_PROD_PARQUET_TABLE_NAME = 'taxi_availability_data_parquet_tbl_PROD'
NEW_PROD_PARQUET_TABLE_S3_BUCKET = 's3://parquet-taxi-availability-table-prod-1'
